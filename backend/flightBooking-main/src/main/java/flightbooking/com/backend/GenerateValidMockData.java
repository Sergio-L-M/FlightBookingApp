...
public class GenerateValidMockData {
    ...
    public static void main(String[] args) {
        try {
            ...
            AmadeusExtractGeneralData generalDataService = new AmadeusExtractGeneralData();
            ...
            AmadeusFlightService amadeusFlightService = new AmadeusFlightService(
                    null, generalDataService, itinerariesService, sortFlights, priceService
            );

            // ✅ Ejecutar transformResponse() con los datos mockeados
            List<Map<String, Object>> transformedData = amadeusFlightService.transformResponse(mockJsonString);
